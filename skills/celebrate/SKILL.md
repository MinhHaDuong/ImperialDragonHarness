...
3. **Update STATE.md**: rewrite per spec in rules. Delete completed next-actions. No changelog.
4. **Update ROADMAP.md**: check off completed items. Delete items checked off before this session.
