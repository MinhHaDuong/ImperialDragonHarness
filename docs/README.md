...
| `5 levels of harnessing.md` | 5-level harness maturity framework |
...
| `2026-09-10-dragon-memory-design.md` | Design draft for the harness memory system: what it does, what was measured, what is proposed |
...
Superseded or unrelated files moved to `archive/`.
