...
**Merged from `feedback_gaze_external_seats_fail_open.md` (2026-09-25):** reviewers.sh reviews the harness repo unless REVIEWERS_REPO=<project worktree> is set (REPO_ROOT does nothing). Before trusting an empty harvest, confirm a seat ran (findings file present, .err absent).
