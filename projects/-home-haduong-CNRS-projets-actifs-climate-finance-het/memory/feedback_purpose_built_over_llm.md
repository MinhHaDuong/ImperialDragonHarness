...
**Merged from `reference_grobid_padme` (2026-09-25):** GROBID 0.8.1 runs on padme via podman (port 8070, processCitation, ~200 citations/s); check the container is up before use.
