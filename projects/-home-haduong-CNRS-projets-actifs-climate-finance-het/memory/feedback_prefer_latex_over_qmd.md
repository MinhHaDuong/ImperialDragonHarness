...
**Merged from `feedback_quarto_pipe_tables_cannot_float` (2026-09-25):** In existing QMD, captioned pipe tables become non-floating longtables; only a raw-LaTeX tabular in a ::: {#tbl-x tbl-pos="tbp"} div floats.
