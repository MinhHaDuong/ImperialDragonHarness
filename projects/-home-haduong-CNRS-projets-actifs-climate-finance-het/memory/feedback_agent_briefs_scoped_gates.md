...
**Merged from `feedback_no_shared_env_sync_during_sibling_agent.md` (2026-09-25):** Why: the shared /data env has no per-worktree isolation; a sync mid-run flipped the openalex-corpus path dep and crashed a sibling's testmon (0213 raid).
