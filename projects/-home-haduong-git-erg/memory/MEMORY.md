...
- [sweep emitted vs gated surface](feedback_sweep_emitted_vs_gated_surface.md) — class-sweep by surface category (emitted-into-adopter & guaranteed-hit vs file-gated dev hint), not the surface string; 0242 hook fix did NOT extend to version.go's make-build hint
