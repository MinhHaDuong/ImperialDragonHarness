...
- [Project data path](project_data_path.md)
- [Python tooling: uv](feedback_uv_not_pip.md)
- [Infra PADME](infra_padme.md)
- [Format preference](feedback_format_preference.md)
- [Corpus exclusions](feedback_corpus_exclusions.md)
- [Real billing for cost analysis](feedback_real_billing_not_estimates.md)
- [OpenRouter billing sources](reference_openrouter_billing.md)
...
- [Décisions créatives](project_kieu_decisions.md)
- [Pipeline IA — règles](feedback_pipeline_ia.md)
- [Style des voix](feedback_style_voix.md)
- [Style coda et intro](feedback_coda_intro_style.md)
