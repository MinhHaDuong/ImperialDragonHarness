...
- [Sortie git sous rtk non fiable](feedback-rtk-sortie-git-non-fiable.md) — `git log --oneline` a renvoyé des SHAs plausibles mais faux ; lire l'état à la plomberie ou via `rtk proxy`
