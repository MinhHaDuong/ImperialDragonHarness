...
- [erg log stamp must match wall clock](feedback_erg_log_stamp_must_match_wall_clock.md) — read the clock in the SAME call that writes; three invented stamps on 2026-09-10
- [This repo runs no CI](project_search_works_has_no_ci.md) — no .github/ anywhere; the AGENTS.md ticket jobs never fire here, a hand-run make check is the whole gate
...
- [He rules the class, delegates the wording](feedback_he_rules_the_class_delegates_the_wording.md) — a spec that restates the shipped sentence takes the delegation back; delete the copy, keep the class names
