...
- [A pgrep waiter matches its own command line](feedback_pgrep_waiter_matches_itself.md) — it waits for itself forever, looks exactly like a slow job, and outlives the session: 14 h 57 reparented to init, found by accident
